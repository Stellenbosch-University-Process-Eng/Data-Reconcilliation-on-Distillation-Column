...
% specified variance
variance = linspace(0.8,1.1,3);

for k = 1:length(variance)
    [measured_data, time] = measureReal(MM, X, v, u, p, tSol, variance(k));
    ...
    sgtitle("Variance analysis of GED strategy")
    xlabel("Specificity"); ylabel("Sensitivity")
    legend("Variance 1 = 0.8", "Variance 2 = 0.95", "Variance 3 = 1.1", "Location", "Best")
