...
% dMM_i/dt = L_i+1 - L_i + L_fi - Qi/lambda
    ...
    for n = 1:p.N-1
        if n == 2
            ddt_MM(n) = u.LF(t) + v.L(n+1,:) - v.L(n,:) - u.Q{n}(t)/p.yy;  % mol/min, Added feed flowrate to MM2
        else
